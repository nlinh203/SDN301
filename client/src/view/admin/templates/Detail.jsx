    ...
    return (
        ...
        >
            <div className="flex flex-wrap text-left">
                <InputFormDetail id="subject" label="Tiêu đề (*)" register={register} errors={errors}
                                 className={'!w-full'}/>
                <InputFormDetail id="code" label="Mã template (*)" register={register} errors={errors}
                                 className={'!w-full'}/>
                ...
                <Editor id="content" label="Nội dung (*)" data={watch('content')}
                        setData={(e) => setValue('content', e)}/>
